      ...
      {!pcapData ? (
        <div className="h-[600px] glass-morphism rounded-3xl border-2 border-dashed border-white border-opacity-10 flex flex-col items-center justify-center p-12 text-center group relative">
          ...
          {isUploading ? (
            ...
            <>
              <div className="p-8 rounded-full bg-white bg-opacity-5 mb-6 group-hover:scale-110 transition-transform">
                <FileCode size={64} className="text-gray-600 group-hover:text-cyber-blue transition-colors" />
              </div>
        ...
        <div className="space-y-8 animate-in fade-in duration-700">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="glass-morphism rounded-3xl overflow-hidden">
                   <div className="p-6 border-b border-white border-opacity-5 flex justify-between items-center">
                      ...
                      <div className="flex gap-2">
                         <div className="px-3 py-1 bg-white bg-opacity-5 rounded-lg text-xs font-mono text-gray-400">SRC IP: 10.0.0.42</div>
                         <div className="px-3 py-1 bg-white bg-opacity-5 rounded-lg text-xs font-mono text-gray-400">PORT: ANY</div>
                      </div>
                   </div>
                   <div className="p-0 overflow-x-auto">
                      <table className="w-full text-left">
                         <thead className="bg-white bg-opacity-5 text-[10px] uppercase text-gray-500 font-mono">
                            <tr>
                         ...
                         <tbody className="text-xs font-mono text-gray-400">
                            {[1, 2, 3, 4, 5].map(i => (
                              <tr key={i} className="border-b border-white border-opacity-5 hover:bg-white hover:bg-opacity-5 transition-all">
             ...
             <div className="space-y-8">
                ...
                <div className="glass-morphism p-8 rounded-3xl border-l-4 border-cyber-red bg-cyber-red bg-opacity-5">
