            ...
            <div className="glass-morphism p-8 rounded-3xl">
               <div className="flex justify-between items-center mb-8">
                  ...
                  <div className="flex gap-2">
                     <span className="px-2 py-1 bg-cyber-green bg-opacity-10 text-cyber-green text-[10px] font-bold rounded border border-cyber-green border-opacity-20">+0.2% YESTERDAY</span>
                  </div>
               </div>
               <div className="h-64">
         ...
         <div className="space-y-8">
            <div className="glass-morphism p-8 rounded-3xl">
               ...
               <div className="space-y-6">
                  <div className="p-4 rounded-2xl bg-white bg-opacity-5 border border-white border-opacity-5">
                     <div className="flex justify-between items-start mb-2">
                        <span className="text-xs text-gray-500 uppercase">Threats (This Week)</span>
                  ...
                  <div className="p-4 rounded-2xl bg-white bg-opacity-5 border border-white border-opacity-5">
                     <div className="flex justify-between items-start mb-2">
                        <span className="text-xs text-gray-500 uppercase">False Positives</span>
            ...
            <div className="glass-morphism p-8 rounded-3xl">
               ...
               <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 rounded-xl bg-white bg-opacity-5">
                  ...
                  <div className="flex justify-between items-center p-3 rounded-xl bg-cyber-red bg-opacity-10 border border-cyber-red border-opacity-20">
                     <div className="flex items-center gap-3">
                        <ShieldAlert size={16} className="text-cyber-red" />
                        <span className="text-sm text-cyber-red">Heuristics Lab</span>
                     </div>
